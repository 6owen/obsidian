...
date: "2024-01-08"
slug: "08-简单使用贝塞尔曲线构造弯曲箭头"
description: "贝塞尔曲线构造弯曲箭头"
collection: "post"
publish: false
draft: false
tags: ["全部","一般般"]
cover: "../assets/blog-b-0e98d892.gif"
---


![b.gif](../assets/blog-b-0e98d892.gif)
...
![image.png](../assets/blog-image-0c25966d.webp)
...
![angle.gif](../assets/blog-angle-77b7c9d7.gif)
...
![image.png](../assets/blog-image-7150ce06.webp)
...
![微信图片_20221114190100.jpg](../assets/blog-微信图片_20221114190100-71c4fc87.webp)
...
![C.gif](../assets/blog-C-365da5b5.gif)

如果要修改其弯曲度，感觉上没有那么优雅，然后看到了`https://excalidraw.com/`的直线效果，就很香。

![bezier curve.gif](../assets/blog-bezier-curve-a73b543c.gif)

最后结合C、S实现了。

![CC.png](../assets/blog-CC-ae783aaa.webp)

![SS.png](../assets/blog-SS-ba4ec1aa.webp)

C就已经可以控制曲线了。S也是生成曲线。
不过其控制点都是虚，不在曲线上。
如果想要一个控制点在曲线上的，拖动控制点即可控制，那么我们需要将其结合起来。

![bezierCS.gif](../assets/blog-bezierCS-e88a0b57.gif)

由上面动图可以知道，当CS配合使用的时候，只需要移动C的最后的实际关键点的位置，和最后一个实际关键点控制点跟它保持相同的相对位置
就能构造出一个控制点在其实线上的贝塞尔曲线。

![CS Line.gif](../assets/blog-CS-Line-f05384d5.gif)
...
![image.png](../assets/blog-image-0996430e.webp)
